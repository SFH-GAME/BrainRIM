...
<div class="change-plan-body">
			...
			<input type="number" name="planNumber" class="planNumber" value="4">
			<div class="container plan-text-body">
			<!--<button type="submit" name="button-change" class="change-plan">Изменить</button>-->
    			<textarea readonly name="planTextArea" placeholder="" id="target" autocomplete="on" maxlength="200" ><?php echo $valueFromDBPlan4['planText'];?></textarea>
			</div>
